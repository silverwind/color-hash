...
var ColorHash = function(options) {
    ...
    this.minS = options.minS || 0;
    this.maxS = options.maxS || 1;
    this.minL = options.minL || 0;
    this.maxL = options.maxL || 1;

    if (this.minH === undefined && this.maxH !== undefined)
        this.minH = 0
    if (this.minH !== undefined && this.maxH === undefined)
        this.maxH = 360
...
ColorHash.prototype.hsl = function(str) {
    ...
    if (S < this.minL) S = this.minS;
    if (S > this.maxL) S = this.maxS;
    if (L < this.minL) L = this.minL;
